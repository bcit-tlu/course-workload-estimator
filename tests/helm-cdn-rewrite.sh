...
EOF
  ...
  check_file "${tmp}/html/index.html" 'href="https://cdn.example/course-workload-estimator/abc1234/favicon.ico"'
  check_file "${tmp}/html/index.html" 'src="https://cdn.example/course-workload-estimator/abc1234/main_bundle.js"'
  check_file "${tmp}/html/index.html" 'href="https://cdn.example/course-workload-estimator/abc1234/style.css"'
  check_file "${tmp}/html/index.html" "src='https://cdn.example/course-workload-estimator/abc1234/bcit_rev.png'"
  check_file "${tmp}/html/index.html" 'href="https://example.org/x.png"'
  check_file "${tmp}/html/main_bundle.js" '"https://cdn.example/course-workload-estimator/abc1234/bcit_rev.png"'
  check_file "${tmp}/html/style.css" 'url(https://cdn.example/course-workload-estimator/abc1234/bcit_rev.png)'
else
